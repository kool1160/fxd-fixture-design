...
The script:
- pins current-control validation to docs/MILESTONE_STATE.json; and
- updates legacy selector tests to prove retirement is unconditional.

It refuses unexpected source and is removed after the repair commit lands.
"""
...
def main() -> None:
    repair_validator()
    repair_tests()
    print("Applied both blocking PR #67 review repairs.")
