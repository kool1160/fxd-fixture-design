...
from fxd_geometry import (EngineeringAnnotations, ValidationResult, Vec3,
...
# This synthetic proof provides explicit review evidence; it never represents
# production approval and leaves real deterministic validation authoritative.
validation = ValidationResult(
    "fxd-validation-v1", concept.identity, concept.fixture.source_sha256,
    "mm", "provisional", (), "synthetic-export-proof-evidence",
)
package = build_fabrication_package(concept, "A", validation=validation)
